    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->NewFile->setIcon(QPixmap(":/images/NewFile.png"));
    ui->OpenFile->setIcon(QPixmap(":/images/OpenFile.png"));
    ui->SaveFile->setIcon(QPixmap(":/images/SaveFile.jpg"));
    ui->SaveAllFile->setIcon(QPixmap(":/images/SaveAllFile.png"));
